...
var _debug = require("babel-preset-react-app/node_modules/@babel/preset-env/lib/debug");

var _getOptionSpecificExcludes = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/get-option-specific-excludes"));

var _filterItems = require("babel-preset-react-app/node_modules/@babel/preset-env/lib/filter-items");

var _moduleTransformations = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/module-transformations"));

var _normalizeOptions = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/normalize-options"));

var _shippedProposals = require("babel-preset-react-app/node_modules/@babel/preset-env/data/shipped-proposals");

var _pluginsCompatData = require("babel-preset-react-app/node_modules/@babel/preset-env/lib/plugins-compat-data");

var _overlappingPlugins = _interopRequireDefault(require("@babel/compat-data/overlapping-plugins"));

var _usagePlugin = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/polyfills/corejs2/usage-plugin"));

var _usagePlugin2 = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/polyfills/corejs3/usage-plugin"));

var _usagePlugin3 = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/polyfills/regenerator/usage-plugin"));

var _entryPlugin = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/polyfills/corejs2/entry-plugin"));

var _entryPlugin2 = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/polyfills/corejs3/entry-plugin"));

var _entryPlugin3 = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/polyfills/regenerator/entry-plugin"));

var _helperCompilationTargets = _interopRequireWildcard(require("@babel/helper-compilation-targets"));

var _availablePlugins = _interopRequireDefault(require("babel-preset-react-app/node_modules/@babel/preset-env/lib/available-plugins"));

var _utils = require("babel-preset-react-app/node_modules/@babel/preset-env/lib/utils");
